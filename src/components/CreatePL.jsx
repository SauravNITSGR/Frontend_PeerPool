  ...
  return (
    <>
      <div className="p-5 sm:w-96 w-full flex flex-col justify-start items-center blue-glassmorphism">
        <input className="my-2 w-full rounded-sm p-2 outline-none bg-transparent text-white border-none text-sm white-glassmorphism" value={ParkingLot.Name} placeholder="Driver Name" name="Name" type="text" onChange={onChange} />
        ...
        <input className="my-2 w-full rounded-sm p-2 outline-none bg-transparent text-white border-none text-sm white-glassmorphism" value={ParkingLot.VehicleType} placeholder={['Car Type : ','BIKE','AUTO','HATCHBACK','MINI SUV','SEDAN','SUV']} name="VehicleType" type="text" onChange={onChange} />
